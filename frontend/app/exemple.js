...
export default function LogementForm() {
    ...
    // Fonction pour annuler et retourner à la page des publications
    const onClose = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // Ici, vous ajouteriez le code pour envoyer les données à votre API
        console.log("Données du formulaire:", formData);

        // Après soumission, rediriger vers la page des publications
        router.push('/profil/publications');
    };

    return (
        <div className="container mx-auto p-4 max-w-3xl">
            <h1 className="text-3xl leading-tight text-blue-500 text-center mb-6">
